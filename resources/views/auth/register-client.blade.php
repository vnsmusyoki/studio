...
<head>
    ...
    <title>Sign up as Client | {{ env('APP_NAME') }}</title>
        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    ...
                    <h4 class="mb-12">Create account as a client</h4>
                </div>

                <form action="{{ route('register-client-account') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($errors->any())
